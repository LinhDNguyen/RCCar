package com.linhnguyen.rccar.view;
...
/**
 * Created by linhn on 3/29/17.
 */

public class CarIndicator extends View {
    ...
    public CarIndicator(Context context) {
        this(context, null);
    }

    public CarIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        initCarView();
    }

    public CarIndicator(Context context, AttributeSet attrs, int defaultStyle) {
        super(context, attrs, defaultStyle);
        initCarView();
    }

    protected void initCarView() {
